...
public class ViewFlow extends AdapterView<Adapter> {
	 ...
	 * 启动轮播
	 * @Description 
	 * @Author Lewis(lgs@yitong.com.cn) 2014年6月22日 下午8:04:48
	 */
	public void startAutoFlowTimer(){
		Logs.d(tag, "启动轮播startAutoFlowTimer()");
		isTimer = true;
		if (handler==null) {
			handler = new Handler(){
				@Override
...
//						Logs.d(tag, "轮播关闭");
	 ...
	 * 停止轮播
	 * @Description 
	 * @Author Lewis(lgs@yitong.com.cn) 2014年6月22日 下午8:04:38
	 */
	public void stopAutoFlowTimer(){
		Logs.d(tag, "轮播关闭stopAutoFlowTimer()");
		if(handler!=null)
